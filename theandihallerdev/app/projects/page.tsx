...
export const metadata: Metadata = {
  title: 'Projects - TheAndiHaller',
  description: 'My projects.',
  alternates: {
    canonical: 'https://theandihaller.com/projects',
  },
};
...
export default async function Blog() {
  ...
  return (
    <div>
      <h2 className="text-2xl md:text-3xl font-bold mb-6 md:mb-8 text-yellow-400">Projects</h2>
